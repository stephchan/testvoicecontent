...
app.post('/', function (req, res) {
  ...
  function sayWeather (forecast) {
    let speechOutput = '<speak>Hold on, I\'m contacting Poncho right now for today\'s weather. <break time="3s"/> <audio src="https://freesound.org/data/previews/110/110011_1537422-lq.mp3"></audio> <break time="3s" /> ohhhhhh kay. <break time="3s"/> Poncho says, ' +
      forecast + 'Remember to check in with Poncho again tomorrow. Have a great day.</speak>';
